...
export class SchoolTableModule1775871809936 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`school_table\` ADD CONSTRAINT \`FK_57507a92d27e14f4bfdc51b4657\` FOREIGN KEY (\`school_uuid\`) REFERENCES \`schools\`(\`uuid\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`school_table\` ADD CONSTRAINT \`FK_98f2b491bf3cc152ee20d483a55\` FOREIGN KEY (\`collaborator_uuid\`) REFERENCES \`collaborators\`(\`uuid\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
